    ...
    */
    class PolygonCollisionSystem : public kantan::System
    {
        ...
        public:
            ...
            std::vector<std::tuple<unsigned int, unsigned int, sf::Vector2f>> getCollisionRecord();
            ...
            void setCollisionResponsePredicate(std::function<bool(unsigned int, unsigned int)> predicate);

        protected:
            // Record of the collisions.
            std::vector<std::tuple<unsigned int, unsigned int, sf::Vector2f>> m_collisions;
			...
			// Predicate.
            std::function<bool(unsigned int, unsigned int)> m_predicate;
    };
} // namespace kantan.
